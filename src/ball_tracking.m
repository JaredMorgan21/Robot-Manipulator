...
try
    ...
    royMask = color_processor.mask_HSV(imgHSV, 0, 90, 80, 255, 255, 255);
    gMask = color_processor.mask_HSV(imgHSV, 100, 70, 0, 130, 255, 255);
    ...
    while height(centroids) > 0
        tic
        robot.point_to_ball(color_processor, cam, mask, ballSize);
